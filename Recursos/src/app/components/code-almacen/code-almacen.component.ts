...
@Component({
  selector: 'app-code-almacen',
  templateUrl: './code-almacen.component.html',
  styleUrls: ['./code-almacen.component.scss'],
})
export class CodeAlmacenComponent implements OnInit {
