...
import { AddRolComponent } from 'src/app/components/add-rol/add-rol.component';
...
export class RolesComponent implements OnInit {
  ...
  ngOnInit() {
    this.key_table = env.TABLE_SIS.role;
    this.getList();
  }
...
/*     if (!data.data.eliminabled) {
    ...
    try {
      await this._apiMongo.delete(env.COLLECTION.general, this.key_table, data.key);
      this.getList();
